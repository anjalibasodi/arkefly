...
Then, just browse to [mlocal.arkefly.nl](http://mlocal.arkefly.nl) and you are ready to start developing!
...
Remember to put all domains you're going to hit in your etc/hosts if you run your server with the `-auto-hosts=false` option.
    ...
    127.0.0.1   mlocal.arkefly.nl
    127.0.0.1   mlocal.werkenbijarkefly.nl
    127.0.0.1   mlocal.chat.arkefly.nl
